...
#define TRANSACTION_task_startActivity		1

#define TRANSACTION_startActivity 		7
#define TRANSACTION_startService 		24
#define TRANSACTION_bindService 		26
#define TRANSACTION_bindIsolatedService	27
#define TRANSACTION_publishService 		30

#define TRANSACTION_getContentProvider	20
#define TRANSACTION_refContentProvider	22
#define TRANSACTION_removeContentProvider	58
/* mobileplus end */
...
private:
	...
	/* mobileplus start */
			int32_t 		mAMHandle;
			int32_t			mATMHandle; 			//ActivityTaskManager Handle;
			int32_t 		mRBMHandle;
			sp<IBinder> 	mRemoteBinderManager;
