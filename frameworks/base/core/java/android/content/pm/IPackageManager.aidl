...
interface IPackageManager {
    ...
    */
	...
	/* mobileplus start */
	List<String> queryIntentActivityNamesOrPackageNames(in Intent intent, String resolvedtype, int flags, int userid);
	List<String> queryIntentServiceNamesOrPackageNames(in Intent intent, String resolvedtype, int flags, int userId);
	//int remoteRegisterApp(String packageName, in PackageInfo pi, int isApkFile);
	/* mobileplus end */
}
